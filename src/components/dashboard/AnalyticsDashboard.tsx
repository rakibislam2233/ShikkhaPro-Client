      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Comprehensive insights into your learning progress and quiz
            performance.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-foreground mt-1">
                {overallStats.totalAttempts.toLocaleString()}
              </p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-foreground mt-1">
                {Math.round(
                  overallStats.totalTime / overallStats.totalAttempts
                )}
                m
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            <p className="text-sm text-blue-700 dark:text-blue-300">
              <strong>Chemistry quizzes</strong> have the highest average score
              (85.1%) and completion rate
            </p>
          </div>

          <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
            <p className="text-sm text-green-700 dark:text-green-300">
              <strong>12.5% increase</strong> in quiz attempts over the selected
              period
            </p>
          </div>
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
            <p className="text-sm text-amber-700 dark:text-amber-300">
              <strong>Hard difficulty</strong> quizzes need attention with 68.4%
              average score
            </p>
          </div>
        </div>
